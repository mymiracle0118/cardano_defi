...
const stakingGuides = [
  {
    ...
    details: [
      "Connect wallet",
      "Press approve to allow your $JS to work the staking contract. Please wait for the transaction to confirm. (If you don't see the 'Approve', button you are likely already approved.)",
      ...
      <DialogContent>
        {stakingGuides.map((data, i) => (
          ...
          >
            ...
            <AccordionDetails>
              {data.summary &&
                (<Typography sx={{ color: 'white', mb: 2 }}>{data?.summary}</Typography>)
              }
